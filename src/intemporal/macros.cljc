    ...
    `(do
       ...
       (defn ~sym ~argv
         ...
         (let [ref#   (:ref i/*env*)
           ...
           (t/log! {:level :debug :_data {:env i/*env* :task task#}}  ["Invoking task" (:sym task#) "with id" (:id task#)])
  ...
  `(fn [& argv#]
     (let [ref#  (:ref i/*env*)
       ...
       (let [store#  (:store i/*env*)
         ...
         (t/log! {:level :debug :_data {:env i/*env* :task task#}}  ["Invoking task" (:sym task#) "with id " id#])
