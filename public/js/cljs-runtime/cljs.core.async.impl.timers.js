...
var i_30264 = (0);
while(true){
if((i_30264 < arr.length)){
(arr[i_30264] = null);

var G__30265 = (i_30264 + (1));
i_30264 = G__30265;
continue;
} else {
}
...
var i_30288 = (self__.level + (1));
while(true){
if((i_30288 <= (new_level + (1)))){
(update[i_30288] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_30290 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30290[i]));
} else {
x__$2.forward.push((((i < links_30290.length))?(links_30290[i]):null));
}

if((i < links_30290.length)){
(links_30290[i] = x__$2);
} else {
links_30290.push(x__$2);
}
...
var i_30292 = (0);
while(true){
if((i_30292 <= self__.level)){
var links_30293 = (update[i_30292]).forward;
if((x__$1 === (((i_30292 < links_30293.length))?(links_30293[i_30292]):null))){
(links_30293[i_30292] = (x__$1.forward[i_30292]));

var G__30294 = (i_30292 + (1));
i_30292 = G__30294;
continue;
} else {
var G__30295 = (i_30292 + (1));
i_30292 = G__30295;
continue;
}
} else {
...
var G__30307 = nx;
var G__30308 = (level__$1 - (1));
x = G__30307;
level__$1 = G__30308;
continue;
} else {
var G__30309 = x;
var G__30310 = (level__$1 - (1));
x = G__30309;
level__$1 = G__30310;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30313 = nx;
var G__30314 = (level__$1 - (1));
x = G__30313;
level__$1 = G__30314;
continue;
} else {
var G__30315 = x;
var G__30316 = (level__$1 - (1));
x = G__30315;
level__$1 = G__30316;
continue;
}
