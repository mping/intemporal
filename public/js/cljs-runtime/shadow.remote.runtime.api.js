...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30003 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30003(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30005 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30005(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30029 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30029(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30052 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30052(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30060 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30060(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30065 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30065(runtime,code);
}
});
...
var input = map__29935__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29935__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29935__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
