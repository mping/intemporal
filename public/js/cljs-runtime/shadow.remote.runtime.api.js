...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36990 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36990(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_36998 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_36998(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_37002 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_37002(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_37007 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_37007(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37009 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37009(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37016 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37016(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__36973,callback){
var map__36974 = p__36973;
var map__36974__$1 = cljs.core.__destructure_map(map__36974);
var input = map__36974__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36974__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36974__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
