...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31023 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31023(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31024 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31024(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31025 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31025(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31026 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31026(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31027 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31027(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31029 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31029(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31019,callback){
var map__31020 = p__31019;
var map__31020__$1 = cljs.core.__destructure_map(map__31020);
var input = map__31020__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31020__$1,new cljs.core.Keyword(null,"code","code",1586293142));
