...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26431 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26431(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_26432 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_26432(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_26442 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_26442(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_26449 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_26449(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26455 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26455(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26459 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26459(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__26413,callback){
var map__26415 = p__26413;
var map__26415__$1 = cljs.core.__destructure_map(map__26415);
var input = map__26415__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26415__$1,new cljs.core.Keyword(null,"code","code",1586293142));
