...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26818 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26818(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_26827 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_26827(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_26838 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_26838(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_26844 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_26844(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26858 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26858(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26868 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26868(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__26799,callback){
var map__26800 = p__26799;
var map__26800__$1 = cljs.core.__destructure_map(map__26800);
var input = map__26800__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26800__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26800__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
