...
var o21746 = temp__5802__auto__;
var temp__5802__auto____$1 = (o21746["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o21747 = temp__5802__auto____$1;
return (o21747["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21547__auto__ = f;
return (o__21547__auto__["toString"]).call(o__21547__auto__);
} else {
return "";
}
...
try{var o__21547__auto___22336 = t;
(o__21547__auto___22336["cljs$lang$ctorPrWriter"]).call(o__21547__auto___22336,t,writer);
}catch (e21754){var __22338 = e21754;
}
...
var char_code = (function (){var o__21547__auto__ = (new String(char$));
return (o__21547__auto__["charCodeAt"]).call(o__21547__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21547__auto__ = String;
return (o__21547__auto__["fromCharCode"]).call(o__21547__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21769 = num_code;
switch (G__21769) {
case (1):
return (185);
...
var o__21547__auto__ = String;
return (o__21547__auto__["fromCharCode"]).call(o__21547__auto__,superscript_code);
});
/**
...
}catch (e21801){var _e__21577__auto__ = e21801;
return false;
}})())){
...
var vec__21802 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21802,(0),null);
...
var len__5769__auto___22376 = arguments.length;
var i__5770__auto___22378 = (0);
while(true){
if((i__5770__auto___22378 < len__5769__auto___22376)){
args__5775__auto__.push((arguments[i__5770__auto___22378]));

var G__22381 = (i__5770__auto___22378 + (1));
i__5770__auto___22378 = G__22381;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21834){
var vec__21835 = p__21834;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21835,(0),null);
...
var G__22394 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__22395 = cljs.core.butlast(remaining_tokens);
name_tokens = G__22394;
remaining_tokens = G__22395;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21829){
var G__21830 = cljs.core.first(seq21829);
var seq21829__$1 = cljs.core.next(seq21829);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21830,seq21829__$1);
}));
...
var vec__21856 = cljs.core.split_with((function (p1__21851_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21851_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21856,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21856,(1),null);
...
var vec__21891 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21891,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21891,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__22408 = cljs.core.rest(remaining_tokens);
var G__22409 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__22408;
name_tokens = G__22409;
continue;
} else {
...
var vec__21912 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(1),null);
var vec__21915 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21915,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21915,(1),null);
var vec__21918 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21918,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21918,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21918,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21918,(3),null);
...
var vec__21942 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__21957 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21957,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21957,(1),null);
var vec__21967 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21967,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21967,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__21978 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__21978) : devtools.munging.parse_fn_info_deep.call(null,G__21978));
})()));
}
} else {
return fn_info;
...
var G__22458 = (arity + (1));
var G__22459 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22021){
var vec__22022 = p__22021;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22022,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22022,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22048_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__22048_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22049_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__22049_SHARP_);
}),sorted_infos);
...
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22065,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22055){
var G__22056 = cljs.core.first(seq22055);
var seq22055__$1 = cljs.core.next(seq22055);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22056,seq22055__$1);
}));
...
var map__22139 = options;
var map__22139__$1 = cljs.core.__destructure_map(map__22139);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22139__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22139__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22139__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22139__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22141 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(5),null);
...
var o__21547__auto__ = f;
return (o__21547__auto__["getBasis"]).call(o__21547__auto__);
});
/**
...
}catch (e22169){var _e__21577__auto__ = e22169;
...
var G__22505 = (obj[cljs.core.first(path)]);
var G__22506 = cljs.core.rest(path);
obj = G__22505;
path = G__22506;
continue;
} else {
...
var _STAR_ = (function (accum,p__22205){
var vec__22206 = p__22205;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22206,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22206,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22266){
var vec__22269 = p__22266;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(2),null);
...
var post_process = (function (p__22297){
var vec__22299 = p__22297;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22299,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22299,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22280_SHARP_){
return (obj[cljs.core.first(p1__22280_SHARP_)]);
}),sorted_matches);
