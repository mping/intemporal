...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29633 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29633(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29636 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29636(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29637 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29637(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29638 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29638(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29640 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29640(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29641 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29641(reader);
}
});
...
var G__29752 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29753 = s.append(c);
c = G__29752;
s = G__29753;
continue;
}
