...
var len__5769__auto___42050 = arguments.length;
var i__5770__auto___42051 = (0);
while(true){
if((i__5770__auto___42051 < len__5769__auto___42050)){
args__5775__auto__.push((arguments[i__5770__auto___42051]));

var G__42052 = (i__5770__auto___42051 + (1));
i__5770__auto___42051 = G__42052;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq41953){
...
var err_42053 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_42054 = (function (p1__41955_SHARP_){
var G__41956 = p1__41955_SHARP_;
...
if(cljs.core.truth_(level__GT_int_42054(x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_42053,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5045__auto__ = level__GT_int_42054(x);
...
var valid_level__GT_int_42056 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return ((valid_level__GT_int_42056.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_42056.cljs$core$IFn$_invoke$arity$1(x) : valid_level__GT_int_42056.call(null,x)) >= (valid_level__GT_int_42056.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_42056.cljs$core$IFn$_invoke$arity$1(y) : valid_level__GT_int_42056.call(null,y)));
});
var fn_QMARK__42057 = cljs.core.fn_QMARK_;
var compile_42058 = taoensso.encore.fmemoize((function (x){
return taoensso.encore.compile_str_filter(x);
}));
var conform_QMARK__STAR__42059 = taoensso.encore.fmemoize((function (x,ns){
var fexpr__41957 = compile_42058(x);
return (fexpr__41957.cljs$core$IFn$_invoke$arity$1 ? fexpr__41957.cljs$core$IFn$_invoke$arity$1(ns) : fexpr__41957.call(null,ns));
}));
var conform_QMARK__42060 = (function (ns_filter,ns){
if(cljs.core.truth_((fn_QMARK__42057.cljs$core$IFn$_invoke$arity$1 ? fn_QMARK__42057.cljs$core$IFn$_invoke$arity$1(ns_filter) : fn_QMARK__42057.call(null,ns_filter)))){
return (ns_filter.cljs$core$IFn$_invoke$arity$1 ? ns_filter.cljs$core$IFn$_invoke$arity$1(ns) : ns_filter.call(null,ns));
} else {
return conform_QMARK__STAR__42059(ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__42060(ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.cljs$core$IFn$_invoke$arity$2((function (p__41958){
var vec__41959 = p__41958;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41959,(0),null);
var min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41959,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__42059(ns_pattern,ns))){
...
var valid_level_42061 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_42062 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
var G__41962 = (function (){var or__5045__auto__ = ((cljs.core.vector_QMARK_(x))?ns__GT__QMARK_min_level_42062(x,ns):x);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return default$;
...
return (valid_level_42061.cljs$core$IFn$_invoke$arity$1 ? valid_level_42061.cljs$core$IFn$_invoke$arity$1(G__41962) : valid_level_42061.call(null,G__41962));
});
var leglist_42063 = (function (x){
if(cljs.core.truth_(x)){
if(cljs.core.truth_((function (){var fexpr__41963 = cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY]);
return (fexpr__41963.cljs$core$IFn$_invoke$arity$1 ? fexpr__41963.cljs$core$IFn$_invoke$arity$1(x) : fexpr__41963.call(null,x));
})())){
return null;
} else {
return x;
...
var ns_whitelist__$1 = leglist_42063(ns_whitelist);
var ns_blacklist__$1 = leglist_42063(ns_blacklist);
...
var level_GT__EQ__42064 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__42065 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_42066 = taoensso.timbre.get_min_level;
var legacy_ns_filter_42067 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = (function (){var G__41966 = default_min_level;
var G__41967 = (function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var G__41968 = _QMARK_ns_str;
return (get_min_level_42066.cljs$core$IFn$_invoke$arity$3 ? get_min_level_42066.cljs$core$IFn$_invoke$arity$3(G__41966,G__41967,G__41968) : get_min_level_42066.call(null,G__41966,G__41967,G__41968));
})();
if(cljs.core.truth_((level_GT__EQ__42064.cljs$core$IFn$_invoke$arity$2 ? level_GT__EQ__42064.cljs$core$IFn$_invoke$arity$2(level,min_level) : level_GT__EQ__42064.call(null,level,min_level)))){
...
var G__41969 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774));
var G__41970 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142));
return (legacy_ns_filter_42067.cljs$core$IFn$_invoke$arity$2 ? legacy_ns_filter_42067.cljs$core$IFn$_invoke$arity$2(G__41969,G__41970) : legacy_ns_filter_42067.call(null,G__41969,G__41970));
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
var ns_filter = temp__5802__auto__;
if(cljs.core.truth_((may_log_ns_QMARK__42065.cljs$core$IFn$_invoke$arity$2 ? may_log_ns_QMARK__42065.cljs$core$IFn$_invoke$arity$2(ns_filter,_QMARK_ns_str) : may_log_ns_QMARK__42065.call(null,ns_filter,_QMARK_ns_str)))){
return true;
} else {
return false;
}
...
var min_level_STAR___$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__41973){
var vec__41974 = p__41973;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41974,(0),null);
var _pattern_min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41974,(1),null);
var entry = vec__41974;
...
var min_level_STAR___$2 = (function (){var temp__5802__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(min_level_STAR___$1),(1)))?(function (){var vec__41977 = min_level_STAR___$1;
var vec__41980 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41977,(0),null);
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41980,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41980,(1),null);
...
var map__41985 = timestamp_opts;
var map__41985__$1 = cljs.core.__destructure_map(map__41985);
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41985__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41988__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__41991){
var map__41992 = p__41991;
var map__41992__$1 = cljs.core.__destructure_map(map__41992);
var data = map__41992__$1;
var msg_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41992__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41992__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41992__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41992__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__41993 = output_opts;
var map__41993__$1 = cljs.core.__destructure_map(map__41993);
var arg__GT_str_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41993__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__41994 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__41994)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__41994)){
return taoensso.timbre.str_join.cljs$core$IFn$_invoke$arity$2(arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__41994)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41994)].join('')));
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__41995){
var map__41996 = p__41995;
var map__41996__$1 = cljs.core.__destructure_map(map__41996);
var data = map__41996__$1;
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41996__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41996__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return [nl,nl,"Caused by:",nl,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__42001 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data,new cljs.core.Keyword(null,"?err","?err",549653299),c);
return (taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1(G__42001) : taoensso.timbre.default_output_error_fn.call(null,G__42001));
})())].join('');
} else {
return null;
}
...
var vec__42002 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42002,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__42005 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42005,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__42008 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42008,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.encore.vrest(vargs__$1):vargs__$1);
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42012__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42012__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42012__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42012__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var instant_42074 = (new Date());
var context_42075 = taoensso.timbre._STAR_context_STAR_;
var vargs_42076 = cljs.core.deref(vargs_);
var vec__42015_42077 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_42076);
var _QMARK_err_42078__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42015_42077,(0),null);
var _QMARK_meta_42079 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42015_42077,(1),null);
var _QMARK_msg_fmt_42080 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42015_42077,(2),null);
var vargs_42081__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42015_42077,(3),null);
var data_42082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_42074,spying_QMARK_,config,vargs_42081__$1,_QMARK_file,(function (){var fexpr__42018 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__42018.cljs$core$IFn$_invoke$arity$1 ? fexpr__42018.cljs$core$IFn$_invoke$arity$1(level) : fexpr__42018.call(null,level));
})(),_QMARK_ns_str,level,msg_type,_QMARK_err_42078__$1,context_42075,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_42078__$1;
}),null)),_QMARK_meta_42079,_QMARK_msg_fmt_42080]));
var _QMARK_data_42083 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_42082,cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5804__auto___42084 = _QMARK_data_42083;
if(cljs.core.truth_(temp__5804__auto___42084)){
var data_42085__$1 = temp__5804__auto___42084;
var map__42019_42086 = data_42085__$1;
var map__42019_42087__$1 = cljs.core.__destructure_map(map__42019_42086);
var vargs_42088__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42019_42087__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_42089__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_42085__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_42088__$2;
}),null)));
var data_42090__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_42089__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn("Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn)(data_42089__$2);
...
return cljs.core.hash((function (){var b2__36890__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_42079,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(b2__36890__auto__)){
var id = b2__36890__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,callsite_id,level], null);
} else {
var b2__36890__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_42079,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__36890__auto____$1)){
var id = b2__36890__auto____$1;
return id;
} else {
var b2__36890__auto____$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_42079,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__36890__auto____$2)){
var h = b2__36890__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_42080,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_42088__$2,callsite_id,_QMARK_msg_fmt_42080,level], null);
}
}
}
})());
}),null))], 0));
var get_timestamp_delay_42091 = (function (){var get_shared_delay = taoensso.encore.fmemoize((function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp(opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_42090__$3,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_42092 = (function (){var base_fn = taoensso.encore.fmemoize(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_42093 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return cljs.core.not((function (){var G__42020 = cljs.core.force(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_42090__$3,new cljs.core.Keyword(null,"hash_","hash_",-827203612)));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__42020) : rl_fn.call(null,G__42020));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__42021 = appender;
var map__42021__$1 = cljs.core.__destructure_map(map__42021);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42021__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42021__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_42091(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_42092(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
...
return base_output_opts_42093;
}
})();
var output_ = (new cljs.core.Delay((function (){
var G__42022 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_42090__$3,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts], 0));
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(G__42022) : output_fn.call(null,G__42022));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_42090__$3,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
 ...
 */
taoensso.timbre.default_config = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"min-level","min-level",1634684919),new cljs.core.Keyword(null,"debug","debug",-1608172596),new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["*",null], null), null),new cljs.core.Keyword(null,"middleware","middleware",1462115504),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807),taoensso.timbre.default_timestamp_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn,new cljs.core.Keyword(null,"appenders","appenders",1245583998),(((typeof window !== 'undefined'))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"console","console",1228072057),(function (){var G__42028 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1(G__42028) : taoensso.timbre.console_appender.call(null,G__42028));
})()], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"println","println",1920840330),(function (){var G__42029 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1(G__42029) : taoensso.timbre.println_appender.call(null,G__42029));
})()], null))], null);
...
var args__5775__auto__ = [];
var len__5769__auto___42105 = arguments.length;
var i__5770__auto___42106 = (0);
while(true){
if((i__5770__auto___42106 < len__5769__auto___42105)){
args__5775__auto__.push((arguments[i__5770__auto___42106]));

var G__42107 = (i__5770__auto___42106 + (1));
i__5770__auto___42106 = G__42107;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq42030){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42030));
}));


var ret__5824__auto___42108 = (function (){
taoensso.timbre.with_log_level = (function taoensso$timbre$with_log_level(var_args){
var args__5775__auto__ = [];
var len__5769__auto___42109 = arguments.length;
var i__5770__auto___42110 = (0);
while(true){
if((i__5770__auto___42110 < len__5769__auto___42109)){
args__5775__auto__.push((arguments[i__5770__auto___42110]));

var G__42111 = (i__5770__auto___42110 + (1));
i__5770__auto___42110 = G__42111;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_log_level.cljs$lang$applyTo = (function (seq42031){
var G__42032 = cljs.core.first(seq42031);
var seq42031__$1 = cljs.core.next(seq42031);
var G__42033 = cljs.core.first(seq42031__$1);
var seq42031__$2 = cljs.core.next(seq42031__$1);
var G__42034 = cljs.core.first(seq42031__$2);
var seq42031__$3 = cljs.core.next(seq42031__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42032,G__42033,G__42034,seq42031__$3);
}));
...
var ret__5824__auto___42112 = (function (){
taoensso.timbre.with_logging_config = (function taoensso$timbre$with_logging_config(var_args){
var args__5775__auto__ = [];
var len__5769__auto___42113 = arguments.length;
var i__5770__auto___42114 = (0);
while(true){
if((i__5770__auto___42114 < len__5769__auto___42113)){
args__5775__auto__.push((arguments[i__5770__auto___42114]));

var G__42115 = (i__5770__auto___42114 + (1));
i__5770__auto___42114 = G__42115;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_logging_config.cljs$lang$applyTo = (function (seq42035){
...
var G__42038 = cljs.core.first(seq42035__$2);
var seq42035__$3 = cljs.core.next(seq42035__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42036,G__42037,G__42038,seq42035__$3);
}));
...
var ret__5824__auto___42116 = (function (){
taoensso.timbre.logp = (function taoensso$timbre$logp(var_args){
var args__5775__auto__ = [];
var len__5769__auto___42117 = arguments.length;
var i__5770__auto___42118 = (0);
while(true){
if((i__5770__auto___42118 < len__5769__auto___42117)){
args__5775__auto__.push((arguments[i__5770__auto___42118]));

var G__42119 = (i__5770__auto___42118 + (1));
i__5770__auto___42118 = G__42119;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.logp.cljs$lang$applyTo = (function (seq42039){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42040,G__42041,seq42039__$2);
}));
...
var ret__5824__auto___42120 = (function (){
...
/** @this {Function} */
(taoensso.timbre.with_level.cljs$lang$applyTo = (function (seq42044){
var G__42045 = cljs.core.first(seq42044);
var seq42044__$1 = cljs.core.next(seq42044);
var G__42046 = cljs.core.first(seq42044__$1);
var seq42044__$2 = cljs.core.next(seq42044__$1);
var G__42047 = cljs.core.first(seq42044__$2);
var seq42044__$3 = cljs.core.next(seq42044__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42045,G__42046,G__42047,seq42044__$3);
}));
