...
var G__60460 = sub_val;
var G__60460__$1 = (((G__60460 instanceof cljs.core.Keyword))?G__60460.fqn:null);
switch (G__60460__$1) {
case "submap/nx":
...
if(cljs.core.truth_(temp__5823__auto__)){
var cause = temp__5823__auto__;
var G__60590 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,(xf.cljs$core$IFn$_invoke$arity$1 ? xf.cljs$core$IFn$_invoke$arity$1(cause) : xf.call(null,cause)));
var G__60591 = cause;
acc = G__60590;
error = G__60591;
continue;
...
var temp__5825__auto__ = (((kind instanceof cljs.core.Keyword))?(function (){var G__60531 = kind;
var G__60531__$1 = (((G__60531 instanceof cljs.core.Keyword))?G__60531.fqn:null);
switch (G__60531__$1) {
case "default":
...
})():(cljs.core.truth_(taoensso.truss.error_QMARK_(kind))?cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(kind,error):((cljs.core.fn_QMARK_(kind))?(kind.cljs$core$IFn$_invoke$arity$1 ? kind.cljs$core$IFn$_invoke$arity$1(error) : kind.call(null,error)):((cljs.core.set_QMARK_(kind))?taoensso.truss.impl.rsome((function (p1__60526_SHARP_){
return taoensso.truss.matching_error.cljs$core$IFn$_invoke$arity$2(p1__60526_SHARP_,error);
...
return taoensso.truss.impl.rsome((function (p1__60527_SHARP_){
return taoensso.truss.matching_error.cljs$core$IFn$_invoke$arity$3(kind,p1__60527_SHARP_,error);
}),pattern);
} else {
...
var get_default_error_fn_60599 = (function (base_data){
...
return taoensso.truss.catching_rf.cljs$core$IFn$_invoke$arity$2(get_default_error_fn_60599(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rf","rf",2002878243),rf], null)),rf);
}));

(taoensso.truss.catching_rf.cljs$core$IFn$_invoke$arity$2 = (function (error_fn,rf){
var error_fn__$1 = ((cljs.core.map_QMARK_(error_fn))?get_default_error_fn_60599(error_fn):error_fn);
return (function() {
...
}catch (e60546){var t = e60546;
var G__60547 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rf","rf",2002878243),rf,new cljs.core.Keyword(null,"call","call",-519999866),cljs.core.list(new cljs.core.Symbol(null,"rf","rf",-651557526,null))], null);
var G__60548 = t;
return (error_fn__$1.cljs$core$IFn$_invoke$arity$2 ? error_fn__$1.cljs$core$IFn$_invoke$arity$2(G__60547,G__60548) : error_fn__$1.call(null,G__60547,G__60548));
}});
...
var legacy_ex_data_QMARK__60603 = false;
/**
...
return taoensso.truss.failed_assertion_ex_info.cljs$core$IFn$_invoke$arity$2(legacy_ex_data_QMARK__60603,failed_assertion_info);
}));
...
var map__60564 = failed_assertion_info;
var map__60564__$1 = cljs.core.__destructure_map(map__60564);
var inst = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"inst","inst",645962501));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var coords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"coords","coords",-599429112));
var pred = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"pred","pred",1927423397));
var arg_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"arg-form","arg-form",1400564013));
var arg_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"arg-val","arg-val",1802419280));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60564__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
if(cljs.core.truth_(temp__5825__auto__)){
var vec__60565 = temp__5825__auto__;
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60565,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60565,(1),null);
...
return taoensso.truss.ex_info_STAR_(null,null,msg__$1,(cljs.core.truth_(legacy_ex_data_QMARK___$1)?new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"dt","dt",-368444759),(new Date()),new cljs.core.Keyword(null,"loc","loc",-584284901),(function (){var vec__60568 = coords;
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60568,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60568,(1),null);
...
var G__60572 = (function (){var undefined_arg_QMARK_ = (arg_val instanceof taoensso.truss.impl.ArgEvalError);
...
return (handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__60572) : handler.call(null,G__60572));
} else {
return arg_val;
}
});
...
var G__60576 = (new cljs.core.Delay((function (){
var map__60577 = failed_assertion_info;
var map__60577__$1 = cljs.core.__destructure_map(map__60577);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var coords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"coords","coords",-599429112));
var pred = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"pred","pred",1927423397));
var arg_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"arg-form","arg-form",1400564013));
var arg_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"arg-val","arg-val",1802419280));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60577__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var vec__60578 = coords;
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60578,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60578,(1),null);
...
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__60576) : f.call(null,G__60576));
});
} else {
return null;
}
